...
export const listData = async(): Promise<Array<any>> => {
...
export const getResult = async (taskId: string, dataUserSk: string,
  arweave: Arweave = Arweave.init({}), timeout: number = 10000): Promise<Uint8Array> => {
 ...
 * @returns The data
 */
export const submitTaskAndGetResult = async (dataId: string, dataUserPk: string, dataUserSk: string, wallet: any,
